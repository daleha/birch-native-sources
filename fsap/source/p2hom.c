...
#define VERSION         "P2HOM         Version  5/13/91 "
...
Static NODE *DIPEPTIDE[(long)ARG - (long)GLY + 1][(long)ARG - (long)GLY + 1];
Static NODE *FREELIST;
Static Char AACHAR[25];
Static long STARTX, FINISHX, STARTY, FINISHY, HOMRANGE, MINPER, COMPFACT,
	    LINESIZE, MAXSCORE, TWOMATCH, MINSCORE;
...
Static Void INITIALIZE()
{
  ...
  for (A1 = GLY; (long)A1 <= (long)ARG; A1 = (AMINOACID)((long)A1 + 1)) {
    for (A2 = GLY; (long)A2 <= (long)ARG; A2 = (AMINOACID)((long)A2 + 1))
      DIPEPTIDE[(long)A1 - (long)GLY][(long)A2 - (long)GLY] = NULL;
  }
}  /* INITIALIZE */
...
struct LOC_QUICKSEARCH *LINK;
{
  ...
  for (V.I = RIGHT; V.I >= LEFT; V.I--) {
    ...
    A2 = SEQX[V.I + MAXRANGE + 1];
    if ((long)A1 <= (long)ARG && (long)A2 <= (long)ARG)
      ADDNODE(&DIPEPTIDE[(long)A1 - (long)GLY][(long)A2 - (long)GLY], &V);
  }
}  /*MAKETABLE*/
...
struct LOC_QUICKSEARCH *LINK;
{
  ...
  for (A1 = GLY; (long)A1 <= (long)ARG; A1 = (AMINOACID)((long)A1 + 1)) {
    for (A2 = GLY; (long)A2 <= (long)ARG; A2 = (AMINOACID)((long)A2 + 1)) {
      if (DIPEPTIDE[(long)A1 - (long)GLY][(long)A2 - (long)GLY] != NULL) {
	HEAD = DIPEPTIDE[(long)A1 - (long)GLY][(long)A2 - (long)GLY];
	TAIL = HEAD;
 ...
 * Note: Using % for possibly-negative arguments [317] */
    ...
    for (V.POSY = STARTY; V.POSY <= FORLIM; V.POSY++) {
      ...
      A2 = SEQY[V.POSY + MAXRANGE + 1];
      if ((long)A1 <= (long)ARG && (long)A2 <= (long)ARG)
	SEARCHFOR(DIPEPTIDE[(long)A1 - (long)GLY][(long)A2 - (long)GLY], &V);
      INDEX++;
      if (INDEX == COMPFACT) {
	if (K < 9) {
